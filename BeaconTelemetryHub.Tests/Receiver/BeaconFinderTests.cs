...
namespace BeaconTelemetryHub.Tests.Receiver
{
    ...
    public class BeaconFinderTests
    {
        ...
        private Mock<IOptions<BeaconTelemetryHubSettings>> _settingsMock = null!;
        private Mock<IBleAdapter> _adapterMock = null!;
        private BeaconTelemetryHubSettings _settings = null!;
        ...
        public void Setup()
        {
            ...
            _settingsMock = new Mock<IOptions<BeaconTelemetryHubSettings>>();

            _settings = new BeaconTelemetryHubSettings
            {
